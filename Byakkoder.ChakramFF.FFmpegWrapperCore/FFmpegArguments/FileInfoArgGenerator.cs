...
{
    public class FileInfoArgGenerator : ISingleArgGenerator<FileInfoArg>
    {
        #region Public Methods
        
        public string Generate(FileInfoArg sourceArg)
        {
            return string.Format(FFmpegArgsResources.FileInfo, sourceArg.FilePath);
        } 
