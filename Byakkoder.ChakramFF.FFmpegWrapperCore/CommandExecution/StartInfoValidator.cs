...
{
    public class StartInfoValidator : IStartInfoValidator
    {
        #region Fields
        ...
        public StartInfoValidator(IFileWrapper fileWrapper)
        {
        ...
        public void Validate(string exePath, string arguments)
        {
            if (string.IsNullOrWhiteSpace(exePath))
            {
                throw new ArgumentException("ExePath missing.");
            }
